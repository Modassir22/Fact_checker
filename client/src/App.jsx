...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between relative overflow-hidden bg-slate-50 text-slate-900">
      ...
      <main className="max-w-7xl w-full mx-auto px-6 flex-1 flex flex-col justify-center relative z-10">
        ...
        {(status === 'IDLE' || status === 'PARSING') ? (
          ...
          <div className="py-6 space-y-6 relative h-[calc(100vh-180px)] overflow-hidden">
            ...
            <div className="fixed inset-0 bg-slate-50/70 backdrop-blur-[2px] z-50 flex flex-col items-center justify-center gap-4">
              <div className="bg-white border border-slate-300 px-12 py-10 rounded-3xl shadow-2xl flex flex-col items-center gap-5 max-w-sm">
                <div className="w-12 h-12 border-4 border-slate-900 border-t-transparent rounded-full animate-spin"></div>
                <span className="text-lg font-extrabold text-slate-900 tracking-tight text-center">Analyzing is loading...</span>
                <span className="text-xs text-slate-400 font-bold uppercase tracking-widest text-center">Checking live web data</span>
              </div>
            </div>
          ...
          <div className="py-6 space-y-6 animate-fadeIn">
            ...
            <div className="bg-white border border-slate-200 p-4.5 rounded-2xl shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="bg-slate-100 p-2.5 rounded-xl text-slate-700 shrink-0">
                  <FileText className="h-5 w-5" />
                </div>
                <div className="text-left">
                  <h3 className="text-sm font-bold text-slate-900 tracking-wide">{verificationData.metadata.fileName}</h3>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs px-4 py-2.5 rounded-xl shadow transition-all"
                >
                ...
                <button
                  onClick={handleReset}
                  className="flex items-center gap-1.5 bg-white border border-slate-250 hover:bg-slate-50 text-slate-750 font-bold text-xs px-4 py-2.5 rounded-xl shadow-sm transition-all"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-blue-600 rounded-xl p-5 text-white shadow-sm flex flex-col justify-between h-[115px]">
                <div className="flex items-center justify-between opacity-80 text-[10px] font-bold uppercase tracking-widest">
              ...
              <div className="bg-cyan-500 rounded-xl p-5 text-white shadow-sm flex flex-col justify-between h-[115px]">
                <div className="flex items-center justify-between opacity-80 text-[10px] font-bold uppercase tracking-widest">
              ...
              <div className="bg-rose-500 rounded-xl p-5 text-white shadow-sm flex flex-col justify-between h-[115px]">
                <div className="flex items-center justify-between opacity-80 text-[10px] font-bold uppercase tracking-widest">
              ...
              <div className="bg-emerald-500 rounded-xl p-5 text-white shadow-sm flex flex-col justify-between h-[115px]">
                <div className="flex items-center justify-between opacity-80 text-[10px] font-bold uppercase tracking-widest">
      ...
      <footer className="w-full py-6 border-t border-slate-200 bg-white z-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-[10px] text-slate-500 tracking-wider uppercase font-bold">
